...
class WeeklyReportCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $booksBorrowed = BookUser::select('date_out')->whereBetween('date_out', [$toString, $fromString])->get()->count();
        $booksReturned = BookUser::select('date_in')->whereBetween('date_in', [$toString, $fromString])->get()->count();
